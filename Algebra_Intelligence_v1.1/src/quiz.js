...
var Factor = require('./factor.js'); // needed for quadratic roots.
 ...
 * @param userRatings the user's current skill levels.
 * @constructor
 */
function Quiz(numQuestions, userRatings) {
    ...
    this.generate = function (quiz, callback) {
        ...
        loadTemplates(Unique(categoriesUnique),
            function (templates) {
                for (var i = 0; i < quiz.getNumberOfQuestions(); i++) {
                    var Template = null;
     ...
     * @param categories the list of categories in this quiz.
    ...
    /**
     * Convert a finished quiz to HTML Text.
    ...
    /**
     * Convert a question to HTML text.
