...
function SolveLinearEquationTemplate() {
   ...
   */
    ...
    this.instantiateQuestion = function (skillLevel) {
        ...
        var qAnswerInfo = generateAnswerInfo(A, B, C,skillLevel);
  ...
  var generateTemplateComponents = function(skillLevel){
    ...
    switch(skillLevel){
      ...
      case 2:
        ...
        A = random.generateRandomNonZeroInteger(-20,20);
        B = random.generateRandomNonZeroInteger(-20,20);
        C = random.generateRandomNonZeroInteger(-20,20);
        break;
      case 3:
      ...
      case 4:
        ...
        B = random.generateRandomDecimal(-10,10,2);
      ...
      default: //skill level 5.
        ...
        B = random.generateRandomDecimal(-5,5,round);
  ...
  /**
    ...
    var generateAnswerInfo = function (a, b, c) {
        ...
        /*var skill = parseInt(getCookie("linearEqSkill"));
        if(skill === 3){
          correctAnswer = correctAnswer.toFixed(2);
          incorrectAnswerA = incorrectAnswerA.toFixed(2)
          incorrectAnswerB = incorrectAnswerB.toFixed(2)
          incorrectAnswerC = incorrectAnswerC.toFixed(2)
        }
        else if(skill > 3) {
          correctAnswer = correctAnswer.toFixed(2);
          incorrectAnswerA = incorrectAnswerA.toFixed(2)
