...
function SolveLinearEquationTemplate() {
      this.category = "Linear Equations";
    ...
    var generateAnswerInfo = function (a, b, c) {
        ...
        var incorrectAnswerB = (c / a - b).toFixed(2);
        var incorrectAnswerC = (correctAnswer + addNum).toFixed(2);
...
module.exports = SolveLinearEquationTemplate;

var z = SolveLinearEquationTemplate;
var x = new z();
console.log(x.getCategory());